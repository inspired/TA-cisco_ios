...
Version 2.2.0 of the Cisco Networks Add-on is compatible with:
...
Version 2.2.0 of the Cisco Networks Add-on incorporates the following third-party software or libraries.
