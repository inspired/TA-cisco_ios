...
Version 2.6.0 of the Cisco Networks Add-on is compatible with:

| Splunk Enterprise versions | 5.0.x, 6.*, 7.*, 8.* |
| --- | --- |
| CIM | 4.* |
...
Version 2.6.0 of the Cisco Networks Add-on fixes the following issues:

- Excludes Cisco FTD events from being part of field extractions and sourcetype rewrites

##### Known issues

Version 2.6.0 of the Cisco Networks Add-on has the following known issues:

- None known

##### Third-party software attributions

Version 2.6.0 of the Cisco Networks Add-on incorporates the following third-party software or libraries.
...
- Optional: Cisco Networks App, 2.6.0 or higher (for dashboards etc)
